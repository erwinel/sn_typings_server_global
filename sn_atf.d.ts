...
declare namespace $$tableFields {
    ...
    export interface sys_atf_step_config extends sys_metadata {
         ...
         * Default Value: false.
         */
        can_mutate_page: GlideElementBoolean;
         ...
         * Max Length: 8000.
         */
        description_generator: GlideElementScript;
        
        /**
         * "HTML description" column element.
         * Mandatory: true; Max Length: 8000.
         */
        html_description: GlideElementTranslatedHTML;
         ...
         * Max Length: 8000.
         */
        step_execution_generator: GlideElementScript;
        
        /**
         * "Template reminder" column element.
         * Mandatory: true; Max Length: 255.
         */
        template_reminder: GlideElementTranslatedText;
    ...
    export interface sys_atf_step_env extends sys_metadata {
         ...
         * Default Value: true.
         */
        has_batch_constraint: GlideElementBoolean;
