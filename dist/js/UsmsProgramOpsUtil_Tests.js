...
var UsmsProgramOpsUtil_Tests;
(function (UsmsProgramOpsUtil_Tests) {
    // Step 1: normalizeWhitespace
    (function normalizeWhitespaceTest(outputs, steps, stepResult, assertEqual) {
    ...
    (function validateExpirationDateTest(outputs, steps, stepResult, assertEqual) {
        describe('x_g_doj_usmsprogop.UsmsProgramOpsUtil.validateExpirationDate tests', function () {
            it('expiration = nil is true', function () {
                var gr = new GlideRecord('x_g_doj_usmsprogop_u_cmdb_ci_group_access_assignment');
                gr.initialize();
    ...
    */
    ...
    (function validatePhysicalNetworkTest(outputs, steps, stepResult, assertEqual) {
        describe('x_g_doj_usmsprogop.UsmsProgramOpsUtil.validatePhysicalNetwork tests', function () {
            it('Setting circular u_restricted_transfer_networks reference should return false', function () {
                var gr = new GlideRecord("x_g_doj_usmsprogop_u_cmdb_ci_physical_network");
            ...
            it('Adding duplicate u_restricted_transfer_networks values should return removed SysIDs', function () {
                ...
                expect(actual[0]).toBe(ref_id);
                expect(actual[1]).toBe(ref_id);
    ...
    (function toCommaSeparatedPhraseTest(outputs, steps, stepResult, assertEqual) {
    ...
    jasmine.getEnv().execute();
    // Step 9: copyArray
    (function copyArrayTest(outputs, steps, stepResult, assertEqual) {
    ...
    jasmine.getEnv().execute();
})(UsmsProgramOpsUtil_Tests || (UsmsProgramOpsUtil_Tests = {}));
