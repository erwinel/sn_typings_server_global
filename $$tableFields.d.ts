...
declare namespace $$tableFields {
    ...
    /**
     * "Notification" GlideRecord fields.
     * @see {@link $$GlideRecord.sysevent_email_action}
     * @see {@link $$GlideElement.sysevent_email_action}
     */
    export interface sysevent_email_action extends sysrule {
        /**
        ...
        /**
         * "Affected field on event" column element.
         * Type: "Choice" (choice).
         * Max Length: 40
         */
         ...
         * References: Notification Category
         * Mandatory: true
         * Default Value: javascript:gs.getProperty('glide.notification.default_category', 'c97d83137f4432005f58108c3ffa917a');
         * @see {@link $$GlideRecord.sys_notification_category}
         */
        category: $$GlideElement.sys_notification_category;
        ...
        /**
         * "Default Interval" column element.
         * References: Digest Interval
         * @see {@link $$GlideRecord.sys_email_digest_interval}
         */
        default_interval: $$GlideElement.sys_email_digest_interval;

        /**
         * "Allow Digest" column element.
         * Type: True/False (boolean).
         * Default Value: false
         */
        ...
        /**
         * "Digest From" column element.
         * Max Length: 100
         */
        digest_from: GlideElement;

        /**
         * "Digest HTML" column element.
         * Type: "HTML Script" (html_script).
         * Max Length: 4000
         */
        digest_html: GlideElement;

        /**
         * "Digest Reply To" column element.
         * Max Length: 100
         */
        digest_reply_to: GlideElement;

        /**
         * "Digest Separator (HTML)" column element.
         * Type: "HTML Script" (html_script).
         * Max Length: 4000
         * Default Value: <br><hr><br>
         */
        digest_separator_html: GlideElement;

        /**
         * "Digest Separator (text)" column element.
         * Type: "Email Script" (email_script).
         * Max Length: 4000
         * Default Value: \n--------------------------------------------------------------------------------\n
         */
        ...
        /**
         * "Digest Subject" column element.
         * Max Length: 100
         */
        digest_subject: GlideElement;

        /**
         * "Digest Template" column element.
         * References: Email Template
         * @see {@link $$GlideRecord.sysevent_email_template}
         */
        digest_template: $$GlideElement.sysevent_email_template;

        /**
         * "Digest Text" column element.
         * Type: "Email Script" (email_script).
         * Max Length: 4000
         */
        ...
        /**
         * "Enable Dynamic Translation" column element.
         * Type: True/False (boolean).
         * Default Value: false
         */
        enable_dynamic_translation: GlideElementBoolean;

        /**
         * "Event name" column element.
         * Type: "System Event Name" (sysevent_name).
         * Max Length: 40
         */
        event_name: GlideElement;

        /**
         * "Event parm 1 contains recipient" column element.
         * Type: True/False (boolean).
         */
        event_parm_1: GlideElementBoolean;

        /**
         * "Event parm 2 contains recipient" column element.
         * Type: True/False (boolean).
         */
        event_parm_2: GlideElementBoolean;

        /**
         * "Exclude delegates" column element.
         * Type: True/False (boolean).
         * Default Value: false
         */
        ...
        /**
         * "Send when" column element.
         * Max Length: 40
         * Default Value: engine
         */
        generation_type: GlideElement;

        /**
         * "Importance" column element.
         * Max Length: 40
         */
        importance: GlideElement;

        /**
         * "Include attachments" column element.
         * Type: True/False (boolean).
         */
         ...
         * "Item" column element.
         * Max Length: 40
         * Default Value: event.parm1
         */
        item: GlideElement;

        /**
         * "Item table" column element.
         * Type: "Table Name" (table_name).
         * Max Length: 40
         */
        item_table: GlideElement;
        ...
        /**
         * "Push Messages" column element.
         * Type: List (glide_list)
         */
        message_list: GlideElement;

        /**
         * "Message text" column element.
         * Type: "Email Script" (email_script).
         * Max Length: 4000
         */
        ...
        /**
         * "Push Message Only" column element.
         * Type: True/False (boolean).
         * Default Value: false
         */
        ...
        /**
         * "Users/Groups in fields" column element.
        ...
        /**
         * "Reply to" column element.
         * Max Length: 100
         */
        reply_to: GlideElement;

        /**
         * "Send to event creator" column element.
         * Type: True/False (boolean).
         * Default Value: true
         */
        ...
        /**
         * "Stationery" column element.
         * References: Stationery
         * @see {@link $$GlideRecord.sysevent_email_style}
         */
        style: $$GlideElement.sysevent_email_style;
        ...
        /**
         * "Sys version" column element.
         * Max Length: 40
         * Default Value: 2
         */
        sys_version: GlideElement;

        /**
         * "Email template" column element.
         * References: Email Template
         * @see {@link $$GlideRecord.sysevent_email_template}
         */
        template: $$GlideElement.sysevent_email_template;
    ...
    /**
     * "Notification Category" GlideRecord fields.
     * @see {@link $$GlideRecord.sys_notification_category}
     * @see {@link $$GlideElement.sys_notification_category}
     */
    export interface sys_notification_category extends sys_metadata {
        /**
         * "Name" column element.
         * Type: Translated Text (translated_text).
         * Max Length: 32; Mandatory: true
         * Unique: true
         */
        name: GlideElementTranslatedText;
    ...
    /**
     * "Digest Interval" GlideRecord fields.
     * @see {@link $$GlideRecord.sys_email_digest_interval}
     * @see {@link $$GlideElement.sys_email_digest_interval}
     */
    export interface sys_email_digest_interval extends IBaseRecord {
        /**
         * "Interval" column element.
         * Type: Type: Duration (glide_duration); scalar type: date
         */
        interval: GlideElementGlideObject;
    ...
    /**
     * "Email Template" GlideRecord fields.
     * @see {@link $$GlideRecord.sysevent_email_template}
     * @see {@link $$GlideElement.sysevent_email_template}
     */
    export interface sysevent_email_template extends sys_metadata {
        /**
         * "Table" column element.
         * Type: "Table Name" (table_name).
         * Max Length: 80
        ...
        /**
         * "Email layout" column element.
         * References: Email Layout
         * @see {@link $$GlideRecord.sys_email_layout}
         */
        email_layout: $$GlideElement.sys_email_layout;
    ...
    /**
     * "Email Layout" GlideRecord fields.
     * @see {@link $$GlideRecord.sys_email_layout}
     * @see {@link $$GlideElement.sys_email_layout}
     */
    export interface sys_email_layout extends sys_metadata {
        /**
         * "Advanced" column element.
         * Type: True/False (boolean).
         * Default Value: false
        ...
        /**
         * "Advanced Layout" column element.
         * Type: "XML" (xml).
         * Max Length: 65000
         */
        advanced_layout: GlideElement;
         ...
         * Max Length: 65536
         */
        layout: GlideElementGlideObject;
    ...
    /**
     * "Stationery" GlideRecord fields.
     * @see {@link $$GlideRecord.sysevent_email_style}
     * @see {@link $$GlideElement.sysevent_email_style}
     */
    export interface sysevent_email_style extends sys_metadata {
        /**
         * "Name" column element.
         * Max Length: 40
         */
...
(actual_result \u0026gt; 100) scaled_result = 5;\r // else scaled_result = 1;".
    ...
    /**
     * "Wizard Panel Variable" GlideRecord fields.
     * @see {@link $$GlideRecord.expert_panel_variable}
     * @see {@link $$GlideElement.expert_panel_variable}
     */
    export interface expert_panel_variable extends sys_metadata {
        /**
         * "Expert panel" column element.
         * References: Wizard Panel
         * @see {@link $$GlideRecord.expert_panel}
         */
        expert_panel: $$GlideElement.expert_panel;
        ...
        /**
         * "Expert variable" column element.
         * References: Wizard Variable
         * @see {@link $$GlideRecord.expert_variable}
         */
        expert_variable: $$GlideElement.expert_variable;
    ...
    /**
     * "Catalog Wizard Question" GlideRecord fields.
     * @see {@link $$GlideRecord.sc_wizard_question}
     * @see {@link $$GlideElement.sc_wizard_question}
     */
    export interface sc_wizard_question extends sys_metadata {
        /**
         * "Question" column element.
         * References: Variable
         * @see {@link $$GlideRecord.item_option_new}
        ...
        /**
         * "Map to set" column element.
         * Type: True/False (boolean).
         */
        map_to_set: GlideElementBoolean;
        ...
        /**
         * "Question/Set" column element.
         * Max Length: 255; Read-Only: true
         */
        question_or_set: GlideElement;
         ...
         * @see {@link $$GlideRecord.item_option_new_set}
         */
        set: $$GlideElement.item_option_new_set;

        /**
         * "Wizard section" column element.
         * References: Catalog Wizard Section
         * @see {@link $$GlideRecord.sc_wizard_section}
         */
        wizard_section: $$GlideElement.sc_wizard_section;
    }

    /**
     * "Catalog Wizard Section" GlideRecord fields.
     * @see {@link $$GlideRecord.sc_wizard_section}
     * @see {@link $$GlideElement.sc_wizard_section}
     */
    export interface sc_wizard_section extends sys_metadata {
        /**
         * "Name" column element.
         * Type: Translated Text (translated_text).
         * Max Length: 100
        ...
        /**
         * "Wizard step" column element.
         * References: Catalog Wizard Step
         * @see {@link $$GlideRecord.sc_wizard_step}
         */
        wizard_step: $$GlideElement.sc_wizard_step;
    }

    /**
     * "Catalog Wizard Step" GlideRecord fields.
     * @see {@link $$GlideRecord.sc_wizard_step}
     * @see {@link $$GlideElement.sc_wizard_step}
     */
    export interface sc_wizard_step extends sys_metadata {
        /**
         * "Custom step" column element.
         * Type: True/False (boolean).
         */
        custom: GlideElementBoolean;

        /**
         * "Feedback" column element.
         * References: Catalog Wizard Feedback
         * @see {@link $$GlideRecord.sc_wizard_feedback}
         */
        feedback: $$GlideElement.sc_wizard_feedback;

        /**
         * "Hide on template" column element.
         * Type: True/False (boolean).
         */
        hide_on_template: GlideElementBoolean;

        /**
         * "Macroponent" column element.
         * References: UX Macroponent Definition
         * @see {@link $$GlideRecord.sys_ux_macroponent}
         */
        macroponent: $$GlideElement.sys_ux_macroponent;
        ...
        /**
         * "Template feedback" column element.
         * References: Catalog Wizard Feedback
         * @see {@link $$GlideRecord.sc_wizard_feedback}
         */
        template_feedback: $$GlideElement.sc_wizard_feedback;

        /**
         * "Use same feedback in template" column element.
         * Type: True/False (boolean).
         * Default Value: true
         */
        use_same_feedback_in_template: GlideElementBoolean;

        /**
         * "Wizard" column element.
         * References: Catalog Wizard
         * @see {@link $$GlideRecord.sc_wizard}
         */
        wizard: $$GlideElement.sc_wizard;
    }

    /**
     * "Base UI Configuration" GlideRecord fields.
     * @see {@link $$GlideRecord.sc_wizard_feedback}
     * @see {@link $$GlideElement.sc_wizard_feedback}
     */
    export interface sc_wizard_feedback extends sys_metadata {
        /**
         * "Content" column element.
         * Type: Translated HTML (translated_html).
         * Max Length: 2000
    ...
    /**
     * "Catalog Wizard" GlideRecord fields.
     * @see {@link $$GlideRecord.sc_wizard}
     * @see {@link $$GlideElement.sc_wizard}
     */
    export interface sc_wizard extends sys_metadata {
        /**
         * "Active" column element.
         * Type: True/False (boolean).
         * Default Value: true
         ...
         * Max Length: 200
         */
        dynamic_title: GlideElementTranslatedText;

        /**
         * "Has feedback panel" column element.
         * Type: True/False (boolean).
         * Default Value: true
         */
        feeback_panel: GlideElementBoolean;
        ...
        /**
         * "Producer" column element.
         * References: Record Producer
         * @see {@link $$GlideRecord.sc_cat_item_producer}
         */
        producer: $$GlideElement.sc_cat_item_producer;

        /**
         * "Review step label" column element.
         * Type: Translated Text (translated_text).
         * Max Length: 100
         * Default Value: Review and submit
         */
        review_step_label: GlideElementTranslatedText;
        ...
        /**
         * "Show Cancel" column element.
         * Type: True/False (boolean).
         * Default Value: false
         */
        show_cancel: GlideElementBoolean;

        /**
         * "Show review step" column element.
         * Type: True/False (boolean).
         * Default Value: true
         */
        show_review_step: GlideElementBoolean;

        /**
         * "Enable Save" column element.
         * Type: True/False (boolean).
         * Default Value: false
         */
        show_save: GlideElementBoolean;

        /**
         * "Show submit on the last step" column element.
         * Type: True/False (boolean).
         * Default Value: true
         */
        show_submit_on_the_last_step: GlideElementBoolean;

        /**
         * "Submit label" column element.
         * Type: Translated Text (translated_text).
         * Max Length: 100
         * Default Value: Submit
         */
        submit_label: GlideElementTranslatedText;
        ...
        /**
         * "Update label" column element.
         * Type: Translated Text (translated_text).
         * Max Length: 100
         * Default Value: Save
         */
        update_label: GlideElementTranslatedText;
    }

    /**
     * "Wizard Configuration" GlideRecord fields.
     * @see {@link $$GlideRecord.cxs_wizard_config}
     * @see {@link $$GlideElement.cxs_wizard_config}
     */
    export interface cxs_wizard_config extends cxs_ui_config_base {
        /**
         * "Wizard" column element.
         * References: Wizard
         * Mandatory: true
        ...
        /**
         * "Search variable" column element.
         * References: Wizard Variable
         * Mandatory: true
         * @see {@link $$GlideRecord.expert_variable}
         */
        search_variable: $$GlideElement.expert_variable;
    }

    /**
     * "Record Producer Configuration" GlideRecord fields.
     * @see {@link $$GlideRecord.cxs_rp_config}
     * @see {@link $$GlideElement.cxs_rp_config}
     */
    export interface cxs_rp_config extends cxs_ui_config_base {
        /**
         * "Record producer" column element.
         * References: Record Producer
         * Mandatory: true
         * @see {@link $$GlideRecord.sc_cat_item_producer}
         */
        sc_cat_item: $$GlideElement.sc_cat_item_producer;
         ...
         * @see {@link $$GlideRecord.item_option_new}
         */
        search_variable: $$GlideElement.item_option_new;
    }

    /**
     * "Base UI Configuration" GlideRecord fields.
     * @see {@link $$GlideRecord.cxs_ui_config_base}
     * @see {@link $$GlideElement.cxs_ui_config_base}
     */
    export interface cxs_ui_config_base extends sys_metadata {
        /**
         * "Active" column element.
         * Type: True/False (boolean).
         * Default Value: true
        ...
        /**
         * "Allow expand/collapse" column element.
         * Type: True/False (boolean).
         * Default Value: true
         */
        allow_expand_collapse: GlideElementBoolean;

        /**
         * "Search context" column element.
         * References: Search Context
         * Mandatory: true
         * @see {@link $$GlideRecord.cxs_context_config}
         */
        cxs_context_config: $$GlideElement.cxs_context_config;
         ...
         * Type: Translated Text (translated_text).
         * Max Length: 100; Mandatory: true
         * Default Value: Related Search Results
         */
        results_header_text: GlideElementTranslatedText;

        /**
         * "Results per page" column element.
         * Type: Integer (integer).
         */
        results_per_page: GlideElementNumeric;
    ...
    /**
     * "Search Context" GlideRecord fields.
     * @see {@link $$GlideRecord.cxs_context_config}
     * @see {@link $$GlideElement.cxs_context_config}
     */
    export interface cxs_context_config extends sys_metadata {
        /**
         * "Active" column element.
         * Type: True/False (boolean).
         * Default Value: true
        ...
        /**
         * "Searcher" column element.
         * References: Searcher
         * @see {@link $$GlideRecord.cxs_searcher_config}
         */
        cxs_searcher_config: $$GlideElement.cxs_searcher_config;
         ...
         * Default Value: false
         */
        default_config: GlideElementBoolean;

        /**
         * "Searcher default search" column element.
         * Type: "Choice" (choice).
         * Max Length: 40
         * Default Value: all
         */
        default_searcher_resource: GlideElement;
        ...
        /**
         * "Searcher text" column element.
         * Type: Translated Text (translated_text).
         * Max Length: 100
         * Default Value: Default Sources
         */
        searcher_text: GlideElementTranslatedText;

        /**
         * "Search on tab" column element.
         * Type: True/False (boolean).
         * Default Value: true
         */
        search_on_tab: GlideElementBoolean;
        ...
        /**
         * "Enable wildcard searches" column element.
         * Type: True/False (boolean).
         * Default Value: false
         */
        wildcard_search_active: GlideElementBoolean;
    }

    /**
     * "Resource Configuration" GlideRecord fields.
     * @see {@link $$GlideRecord.cxs_res_context_config}
     * @see {@link $$GlideElement.cxs_res_context_config}
     */
    export interface cxs_res_context_config extends sys_metadata {
        /**
         * "Active" column element.
         * Type: True/False (boolean).
         * Default Value: true
        ...
        /**
         * "Search context configuration" column element.
         * References: Search Context
         * @see {@link $$GlideRecord.cxs_context_config}
         */
        cxs_context_config: $$GlideElement.cxs_context_config;
        ...
        /**
         * "Search resource configuration" column element.
         * References: Search Resource
         * @see {@link $$GlideRecord.cxs_search_res_config}
         */
        cxs_search_res_config: $$GlideElement.cxs_search_res_config;

        /**
         * "Default search" column element.
         * Type: True/False (boolean).
         * Read-Only: true
         * Default Value: false
         */
        default_search: GlideElementBoolean;
        ...
        /**
         * "Search operator" column element.
         * Max Length: 40
         * Default Value: IR_AND_OR_QUERY
         */
        search_operator: GlideElement;
    ...
    /**
     * "Search Resource Context Property" GlideRecord fields.
     * @see {@link $$GlideRecord.cxs_res_context_config_prop}
     * @see {@link $$GlideElement.cxs_res_context_config_prop}
     */
    export interface cxs_res_context_config_prop extends sys_metadata {
        /**
         * "Active" column element.
         * Type: True/False (boolean).
         * Default Value: true
        ...
        /**
         * "Choices" column element.
         * Max Length: 512
         */
        choices: GlideElement;

        /**
         * "Resource context configuration" column element.
         * References: Resource Configuration
         * @see {@link $$GlideRecord.cxs_res_context_config}
         */
        cxs_res_context_config: $$GlideElement.cxs_res_context_config;
    ...
    /**
     * "Table Configuration" GlideRecord fields.
     * @see {@link $$GlideRecord.cxs_table_config}
     * @see {@link $$GlideElement.cxs_table_config}
     */
    export interface cxs_table_config extends cxs_ui_config_base {
        /**
         * "Enable Agent Intelligence tab (deprecated)" column element.
         * Type: True/False (boolean).
         * Default Value: true
         */
        agent_intel_tab_active: GlideElementBoolean;

        /**
         * "Allow search with empty search text" column element.
         * Type: True/False (boolean).
         * Default Value: false
         */
        allow_empty_search_term: GlideElementBoolean;

        /**
         * "Allow result preview navigation buttons" column element.
         * Type: True/False (boolean).
         * Default Value: true
         */
        allow_result_preview_buttons: GlideElementBoolean;

        /**
         * "Enable source selector" column element.
         * Type: True/False (boolean).
         * Default Value: true
         */
        enable_source_selector: GlideElementBoolean;
         ...
         */
        match_condition: GlideElementConditions;

        /**
         * "Enable preview buttons" column element.
         * Type: True/False (boolean).
         * Default Value: false
         */
        preview_button_active: GlideElementBoolean;

        /**
         * "Enable related search box" column element.
         * Type: True/False (boolean).
         * Default Value: true
         */
        related_search_active: GlideElementBoolean;

        /**
         * "Required roles" column element.
         * Type: List (glide_list)
         */
        required_roles: GlideElement;

        /**
         * "Enable search as" column element.
         * Type: True/False (boolean).
         * Default Value: false
         */
        search_as_active: GlideElementBoolean;

        /**
         * "Condition" column element.
         * Type: Conditions (conditions).
         */
        search_as_condition: GlideElementConditions;

        /**
         * "Search as field" column element.
         * Type: Field Name (field_name)
         */
        search_as_field: GlideElement;

        /**
         * "Results message" column element.
         * Type: Translated Text (translated_text).
         * Max Length: 255
         * Default Value: Some results may not be displayed due to security constraints
         */
        search_as_results_msg: GlideElementTranslatedText;
         ...
         * Max Length: 8000
         */
        search_as_script: GlideElementScript;

        /**
         * "Show searcher first" column element.
         * Type: True/False (boolean).
         * Default Value: false
         */
        show_searcher_first: GlideElementBoolean;
    ...
    /**
     * "Search Field" GlideRecord fields.
     * @see {@link $$GlideRecord.cxs_table_field_config}
     * @see {@link $$GlideElement.cxs_table_field_config}
     */
    export interface cxs_table_field_config extends sys_metadata {
        /**
         * "Table configuration" column element.
         * References: Table Configuration
         * Mandatory: true
         * @see {@link $$GlideRecord.cxs_table_config}
         */
        cxs_table_config: $$GlideElement.cxs_table_config;
    ...
    /**
     * "Email Configuration" GlideRecord fields.
     * @see {@link $$GlideRecord.cxs_table_email_config}
     * @see {@link $$GlideElement.cxs_table_email_config}
     */
    export interface cxs_table_email_config extends sys_metadata {
        /**
         * "Table configuration" column element.
         * References: Table Configuration
         * Mandatory: true
        ...
        /**
         * "Name" column element.
         * Max Length: 150; Mandatory: true
         * Read-Only: true
         */
        name: GlideElement;

        /**
         * "Email notification" column element.
         * References: Notification
         * Mandatory: true
         * @see {@link $$GlideRecord.sysevent_email_action}
         */
        sysevent_email_action: $$GlideElement.sysevent_email_action;
    ...
    /**
     * "Filter Configuration" GlideRecord fields.
     * @see {@link $$GlideRecord.cxs_table_fltr_config}
     * @see {@link $$GlideElement.cxs_table_fltr_config}
     */
    export interface cxs_table_fltr_config extends cxs_fltr_config {
        /**
         * "Table configuration" column element.
         * References: Table Configuration
         * Mandatory: true; Read-Only: true
    ...
    /**
     * "Filter Condition" GlideRecord fields.
     * @see {@link $$GlideRecord.cxs_table_fltr_condition}
     * @see {@link $$GlideElement.cxs_table_fltr_condition}
     */
    export interface cxs_table_fltr_condition extends cxs_fltr_condition {
        /**
         * "Table Filter Config" column element.
         * References: Filter Configuration
         * Mandatory: true; Read-Only: true
         * @see {@link $$GlideRecord.cxs_table_fltr_config}
         */
        cxs_table_fltr_config: $$GlideElement.cxs_table_fltr_config;

        /**
         * "Compare to" column element.
         * Type: Field Name (field_name)
         * Mandatory: true
         */
        source_field: GlideElement;
    ...
    /**
     * "Searcher" GlideRecord fields.
     * @see {@link $$GlideRecord.cxs_searcher_config}
     * @see {@link $$GlideElement.cxs_searcher_config}
     */
    export interface cxs_searcher_config extends sys_metadata {
        /**
         * "Active" column element.
         * Type: True/False (boolean).
         * Default Value: true
        ...
        /**
         * "Interleave results" column element.
         * Type: True/False (boolean).
         * Default Value: false
         */
        interleave: GlideElementBoolean;
    ...
    /**
     * "Search Action Configuration" GlideRecord fields.
     * @see {@link $$GlideRecord.cxs_ui_action_config}
     * @see {@link $$GlideElement.cxs_ui_action_config}
     */
    export interface cxs_ui_action_config extends sys_metadata {
        /**
         * "Action condition" column element.
         * Type: Conditions (conditions).
         */
        action_condition: GlideElementConditions;

        /**
         * "Action label" column element.
         * Type: Translated Text (translated_text).
         * Max Length: 40; Mandatory: true
         */
        action_label: GlideElementTranslatedText;

        /**
         * "Action undo label" column element.
         * Type: Translated Text (translated_text).
         * Max Length: 40
         */
        action_undo_label: GlideElementTranslatedText;

        /**
         * "Action value" column element.
         * Max Length: 40; Mandatory: true
         * Default Value: This helped
         */
        action_value: GlideElement;
        ...
        /**
         * "Scripted visibility" column element.
         * Type: True/False (boolean).
         */
        advanced_visibility: GlideElementBoolean;

        /**
         * "Attachment type" column element.
         * Max Length: 40
         */
        attachment_type: GlideElement;

        /**
         * "Attach note field" column element.
         * Max Length: 40
         * Default Value: comments
         */
        attach_note_field: GlideElement;

        /**
         * "Badge label" column element.
         * Type: Translated Text (translated_text).
         * Max Length: 40
         */
        badge_label: GlideElementTranslatedText;

        /**
         * "Current action condition" column element.
         * Type: Conditions (conditions).
         */
        current_action_condition: GlideElementConditions;

        /**
         * "Current table" column element.
         * Type: "Table Name" (table_name).
         * Max Length: 80
         */
        current_table: GlideElement;
        ...
        /**
         * "REST API relative path parameter" column element.
         * Max Length: 255
         */
        rest_api: GlideElement;

        /**
         * "Search resource" column element.
         * References: Available Search Resource
         * @see {@link $$GlideRecord.cxs_search_resource}
         */
        search_resource: $$GlideElement.cxs_search_resource;
         ...
         * @see {@link $$GlideRecord.cxs_search_res_config}
         */
        search_res_config: $$GlideElement.cxs_search_res_config;

        /**
         * "Search action" column element.
         * References: Search Actions
         * Mandatory: true
         * @see {@link $$GlideRecord.cxs_ui_action}
         */
        search_ui_action: $$GlideElement.cxs_ui_action;

        /**
         * "Base configuration" column element.
         * References: Base UI Configuration
         * Mandatory: true
         * @see {@link $$GlideRecord.cxs_ui_config_base}
         */
        search_ui_config: $$GlideElement.cxs_ui_config_base;

        /**
         * "Show on new record" column element.
         * Type: True/False (boolean).
         * Default Value: false
         */
        show_on_new: GlideElementBoolean;
        ...
        /**
         * "Trend Recommendation" column element.
         * References: Trend Recommendation [trend_recommendation]
         */
        trend_recommendation: GlideElementReference;

        /**
         * "UI action visibility script" column element.
         * Type: Script (script).
         */
        ui_action_visibility_script: GlideElementScript;

        /**
         * "Use custom field for attach note" column element.
         * Type: True/False (boolean).
         * Default Value: false
         */
        use_custom_field_for_attach: GlideElementBoolean;
    }

    /**
     * "Catalog Portal Page" GlideRecord fields.
     * @see {@link $$GlideRecord.sc_catalog_view_mtom}
     * @see {@link $$GlideElement.sc_catalog_view_mtom}
     */
    export interface sc_catalog_view_mtom extends sys_metadata {
        /**
         * "Default" column element.
         * Type: True/False (boolean).
         * Default Value: false
        ...
        /**
         * "Portal page" column element.
         * References: Portal Page
         * Unique: true
         * @see {@link $$GlideRecord.sys_portal_page}
         */
        sys_portal_page: $$GlideElement.sys_portal_page;
    }

    /**
     * "Price" GlideRecord fields.
     * @see {@link $$GlideRecord.fx_price}
     * @see {@link $$GlideElement.fx_price}
     */
    export interface fx_price extends IBaseRecord {
        /**
         * "Amount" column element.
         * Type: Decimal (decimal).
         */
        amount: GlideElementNumeric;

        /**
         * "Currency" column element.
         * References: Currency
         * Default Value: javascript:GlideLocale.get().getCurrencyCode()
         ...
         * @see {@link $$GlideRecord.fx_price}
         */
        parent: $$GlideElement.fx_price;

        /**
         * "Reference amount" column element.
         * Type: Decimal (decimal).
         */
        reference_amount: GlideElementNumeric;

        /**
         * "Reference currency" column element.
         * References: Currency
         * @see {@link $$GlideRecord.fx_currency}
         */
        reference_currency: $$GlideElement.fx_currency;
    ...
    /**
     * "Catalog Site" GlideRecord fields.
     * @see {@link $$GlideRecord.sc_catalog_site}
     * @see {@link $$GlideElement.sc_catalog_site}
     */
    export interface sc_catalog_site extends sys_metadata {
        /**
         * "CMS 'Continue Shopping' page" column element.
         * Max Length: 100
         */
        cms_continue_shopping: GlideElement;

        /**
         * "CMS homepage" column element.
         * Max Length: 100
         */
        cms_home: GlideElement;

        /**
         * "CMS search page" column element.
         * Max Length: 100
         */
        cms_search: GlideElement;

        /**
         * "Site" column element.
         * References: content_site
         * Mandatory: true
         */
        content_site: GlideElementReference;
    ...
    /**
     * "Available Search Resource" GlideRecord fields.
     * @see {@link $$GlideRecord.cxs_search_resource}
     * @see {@link $$GlideElement.cxs_search_resource}
     */
    export interface cxs_search_resource extends sys_metadata {
        /**
         * "Active" column element.
         * Type: True/False (boolean).
         * Default Value: true
    ...
    /**
     * "Search Resource" GlideRecord fields.
     * @see {@link $$GlideRecord.cxs_search_res_config}
     * @see {@link $$GlideElement.cxs_search_res_config}
     */
    export interface cxs_search_res_config extends sys_metadata {
        /**
         * "Active" column element.
         * Type: True/False (boolean).
         * Default Value: true
        ...
        /**
         * "Searcher configuration" column element.
         * References: Searcher
         * @see {@link $$GlideRecord.cxs_searcher_config}
         */
        cxs_searcher_config: $$GlideElement.cxs_searcher_config;
        ...
        /**
         * "Resource script" column element.
         * Type: Script (Plain) (script_plain).
         * Max Length: 8000
         */
        grsr_script: GlideElementScript;
        ...
        /**
         * "Recommendation" column element.
         * Type: True/False (boolean).
         * Default Value: false
         */
        recommendation: GlideElementBoolean;

        /**
         * "Type" column element.
         * Max Length: 40
         */
        resource_type: GlideElement;
         ...
         * @see {@link $$GlideRecord.cxs_search_resource}
         */
        search_resource_id: $$GlideElement.cxs_search_resource;
    ...
    /**
     * "Search Resource Property" GlideRecord fields.
     * @see {@link $$GlideRecord.cxs_search_res_config_prop}
     * @see {@link $$GlideElement.cxs_search_res_config_prop}
     */
    export interface cxs_search_res_config_prop extends sys_metadata {
        /**
         * "Active" column element.
         * Type: True/False (boolean).
         * Default Value: true
        ...
        /**
         * "Search resource config" column element.
         * References: Search Resource
         * @see {@link $$GlideRecord.cxs_search_res_config}
         */
        cxs_search_res_config: $$GlideElement.cxs_search_res_config;
    ...
    /**
     * "Search Actions" GlideRecord fields.
     * @see {@link $$GlideRecord.cxs_ui_action}
     * @see {@link $$GlideElement.cxs_ui_action}
     */
    export interface cxs_ui_action extends sys_metadata {
        /**
         * "Action ID" column element.
         * Max Length: 40; Mandatory: true
         */
        action_id: GlideElement;
        ...
        /**
         * "Default Condition" column element.
         * Type: Conditions (conditions).
         */
        default_condition: GlideElementConditions;
        ...
        /**
         * "Recommendation Action" column element.
         * Type: True/False (boolean).
         * Default Value: false
         */
        recommendation_action: GlideElementBoolean;
        ...
        /**
         * "UI Types" column element.
         * Type: List (glide_list)
         * Max Length: 4000; Mandatory: true
         */
        ui_types: GlideElement;
    }

    /**
     * "Record Producer Configuration" GlideRecord fields.
     * @see {@link $$GlideRecord.aisa_rp_config}
     * @see {@link $$GlideElement.aisa_rp_config}
     */
    export interface aisa_rp_config extends sys_metadata {
        /**
         * "Active" column element.
         * Type: True/False (boolean).
         * Default Value: true
         ...
         */
        header_text: GlideElementTranslatedText;
        ...
        /**
         * "Search Application" column element.
         * References: Search Application Configuration
         * Mandatory: true
         * @see {@link $$GlideRecord.sys_search_context_config}
         */
        search_app: $$GlideElement.sys_search_context_config;
        ...
        /**
         * "Overrides" column element.
         * References: Record Producer Configuration
         * @see {@link $$GlideRecord.aisa_rp_config}
         */
        sys_overrides: $$GlideElement.aisa_rp_config;
    }

    /**
     * "Wizard Action Configuration Mapping" GlideRecord fields.
     * @see {@link $$GlideRecord.sc_wizard_action_config_mapping}
     * @see {@link $$GlideElement.sc_wizard_action_config_mapping}
     */
    export interface sc_wizard_action_config_mapping extends sys_metadata {
        /**
         * "Hide action" column element.
         * Type: True/False (boolean).
         * Default Value: false
         */
        hide_action: GlideElementBoolean;
        ...
        /**
         * "Wizard action configuration" column element.
         * References: Wizard Action Configuration
         * @see {@link $$GlideRecord.sc_wizard_action_config}
         */
        wizard_action_config: $$GlideElement.sc_wizard_action_config;
    }

    /**
     * "Wizard Action Configuration" GlideRecord fields.
     * @see {@link $$GlideRecord.sc_wizard_action_config}
     * @see {@link $$GlideElement.sc_wizard_action_config}
     */
    export interface sc_wizard_action_config extends sys_metadata {
        /**
         * "Applies to" column element.
         * Type: "Choice" (choice).
         * Max Length: 40
        ...
        /**
         * "Button type override" column element.
         * Type: "Choice" (choice).
         * Max Length: 40
         */
        button_type_override: GlideElement;

        /**
         * "Declarative action" column element.
         * References: Action Assignment
         * Mandatory: true
         * @see {@link $$GlideRecord.sys_declarative_action_assignment}
         */
        declarative_action: $$GlideElement.sys_declarative_action_assignment;

        /**
         * "Force save" column element.
         * Type: True/False (boolean).
         * Default Value: false
         */
        force_save: GlideElementBoolean;
        ...
        /**
         * "Label override" column element.
         * Type: Translated Text (translated_text).
         * Max Length: 100
         */
        label_override: GlideElementTranslatedText;
        ...
        /**
         * "Overflow" column element.
         * Type: True/False (boolean).
         * Default Value: false
         */
        overflow: GlideElementBoolean;
    }

    /**
     * "Action Assignment" GlideRecord fields.
     * @see {@link $$GlideRecord.sys_declarative_action_assignment}
     * @see {@link $$GlideElement.sys_declarative_action_assignment}
     */
    export interface sys_declarative_action_assignment extends sys_metadata {
        /**
         * "Action" column element.
         * References: Action Definition
         * @see {@link $$GlideRecord.sys_declarative_action_definition}
         */
        action: $$GlideElement.sys_declarative_action_definition;

        /**
         * "Component Attributes" column element.
         * Type: Name-Value Pairs (simple_name_values)
         */
        action_attributes: GlideElement;
        ...
        /**
         * "Action Payload" column element.
         * Max Length: 65535
         */
        action_payload: GlideElement;

        /**
         * "Decorator applies to" column element.
         * Type: "Choice" (choice).
         * Max Length: 40
         * Default Value: type
         */
        action_type: GlideElement;
        ...
        /**
         * "Button type" column element.
         * Type: "Choice" (choice).
         * Max Length: 40
         * Default Value: primary
         */
        button_type: GlideElement;

        /**
         * "Specify client action" column element.
         * References: Action Payload Definition
         * Mandatory: true
         * @see {@link $$GlideRecord.sys_declarative_action_payload_definition}
         */
        client_action: $$GlideElement.sys_declarative_action_payload_definition;

        /**
         * "Client Conditions" column element.
         * Type: Name-Value Pairs (simple_name_values)
         * Max Length: 40
         */
        client_conditions: GlideElement;

        /**
         * "Client Conditions on Fields" column element.
         * Type: List (glide_list)
         */
        client_conditions_on_fields: GlideElement;

        /**
         * "Client Script" column element.
         * Type: Script (Plain) (script_plain).
         * Max Length: 8000
         * Default Value: function onClick() { }
         */
        client_script: GlideElementScript;

        /**
         * "Confirmation Message" column element.
         * Type: Translated Text (translated_text).
         * Max Length: 4000
         */
        confirmation_message: GlideElementTranslatedText;

        /**
         * "Confirmation Required" column element.
         * Type: True/False (boolean).
         * Default Value: false
         */
        confirmation_required: GlideElementBoolean;

        /**
         * "Requires create access" column element.
         * Type: True/False (boolean).
         */
        create_access: GlideElementBoolean;

        /**
         * "Render Mode" column element.
         * References: Declarative Action Render Mode
         * @see {@link $$GlideRecord.sys_declarative_action_render_mode}
         */
        declarative_action_render_mode: $$GlideElement.sys_declarative_action_render_mode;

        /**
         * "Implemented as" column element.
         * Type: "Choice" (choice).
         * Max Length: 40
         * Default Value: server_script
         */
        declarative_action_type: GlideElement;

        /**
         * "Requires delete access" column element.
         * Type: True/False (boolean).
         */
        delete_access: GlideElementBoolean;
        ...
        /**
         * "Icon" column element.
         * References: Design System Icons
         * @see {@link $$GlideRecord.st_sys_design_system_icon}
         */
        design_icon: $$GlideElement.st_sys_design_system_icon;

        /**
         * "Dynamic Record Conditions" column element.
         * Type: Conditions (conditions).
         */
        dynamic_record_condition: GlideElementConditions;

        /**
         * "Dynamic Script Condition" column element.
         * Type: "Condition String" (condition_string).
         * Max Length: 254
         */
        dynamic_script_condition: GlideElement;

        /**
         * "Enabled" column element.
         * Type: True/False (boolean).
         * Default Value: true
         */
        enabled: GlideElementBoolean;

        /**
         * "Enable Dynamic Evaluation" column element.
         * Type: True/False (boolean).
         * Default Value: false
         */
        enable_dynamic_evaluation: GlideElementBoolean;

        /**
         * "Enable for all Configurable Experiences" column element.
         * Type: True/False (boolean).
         * Default Value: false
         */
        enable_for_all_experiences: GlideElementBoolean;

        /**
         * "Experience Restricted" column element.
         * Type: True/False (boolean).
         * Default Value: false
         */
        experience_restricted: GlideElementBoolean;
         ...
         * Type: "Choice" (choice).
         * Max Length: 40
         * Default Value: glide_date
         */
        field_type: GlideElement;

        /**
         * "Form Fields Required" column element.
         * Type: True/False (boolean).
         * Default Value: false
         */
        form_fields_required: GlideElementBoolean;

        /**
         * "Form position" column element.
         * Max Length: 40
         */
        form_position: GlideElement;

        /**
         * "Group" column element.
         * References: Declarative Action Group
         * @see {@link $$GlideRecord.sys_declarative_action_group}
         */
        group: $$GlideElement.sys_declarative_action_group;
        ...
        /**
         * "Action Model" column element.
         * References: Action Model Definition
         * Mandatory: true
         * @see {@link $$GlideRecord.sys_declarative_action_model_definition}
         */
        model: $$GlideElement.sys_declarative_action_model_definition;

        /**
         * "Client Conditions" column element.
         * Type: Conditions (conditions).
         */
        model_conditions: GlideElementConditions;

        /**
         * "Model Fields required" column element.
         * Type: List (glide_list)
         */
        model_field_required: GlideElement;

        /**
         * "Order" column element.
         * Type: Order Index (order_index).
         * Default Value: 0
         */
        order: GlideElementNumeric;

        /**
         * "Payload Map" column element.
         * Type: User Roles (user_roles)
         * Max Length: 8000
         */
        payload_map: GlideElement;

        /**
         * "Requires read access" column element.
         * Type: True/False (boolean).
         */
        read_access: GlideElementBoolean;

        /**
         * "Record Conditions" column element.
         * Type: Conditions (conditions).
         */
        record_conditions: GlideElementConditions;

        /**
         * "Record Selection Required" column element.
         * Type: True/False (boolean).
         */
        record_selection_required: GlideElementBoolean;
        ...
        /**
         * "Required user role names" column element.
         * Type: User Roles (user_roles)
         */
        required_user_role_names: GlideElement;

        /**
         * "Requires Value" column element.
         * Type: True/False (boolean).
         * Default Value: false
         */
        requires_value: GlideElementBoolean;

        /**
         * "Scripted Client Condition" column element.
         * Type: "Condition String" (condition_string).
         * Max Length: 254
         */
        scripted_client_condition: GlideElement;

        /**
         * "Script Condition" column element.
         * Type: "Condition String" (condition_string).
         * Max Length: 254
         */
        script_condition: GlideElement;

        /**
         * "Server Script" column element.
         * Type: Script (script).
         * Max Length: 8000
         */
        server_script: GlideElementScript;

        /**
         * "Specificity" column element.
         * Type: Integer (integer).
         * Read-Only: true
         */
        specificity: GlideElementNumeric;
         ...
         * @see {@link $$GlideRecord.sys_declarative_action_assignment}
         */
        sys_overrides: $$GlideElement.sys_declarative_action_assignment;
         ...
         * Max Length: 255
         */
        tooltip: GlideElementTranslatedText;

        /**
         * "Specify UI component" column element.
         * References: UX Component Definition
         * @see {@link $$GlideRecord.sys_ux_lib_component}
         */
        ui_component: $$GlideElement.sys_ux_lib_component;
        ...
        /**
         * "Workspace" column element.
         * References: Workspace
         * @see {@link $$GlideRecord.sys_aw_master_config}
         */
        workspace: $$GlideElement.sys_aw_master_config;

        /**
         * "Requires write access" column element.
         * Type: True/False (boolean).
         */
        write_access: GlideElementBoolean;
    }

    /**
     * "Action Definition" GlideRecord fields.
     * @see {@link $$GlideRecord.sys_declarative_action_definition}
     * @see {@link $$GlideElement.sys_declarative_action_definition}
     */
    export interface sys_declarative_action_definition extends sys_metadata {
        /**
         * "Action Component" column element.
         * References: UX Component Definition
         * Mandatory: true
         * @see {@link $$GlideRecord.sys_ux_lib_component}
         */
        action_component: $$GlideElement.sys_ux_lib_component;

        /**
         * "Action Component Tag" column element.
         * Max Length: 255; Mandatory: true
         * Read-Only: true
         */
        action_component_tag: GlideElement;

        /**
         * "Action Type" column element.
         * Type: "Choice" (choice).
         * Max Length: 40
         * Default Value: action_component
         */
        action_type: GlideElement;

        /**
         * "Applicable To" column element.
         * Type: List (glide_list)
         * References: Action Model Definition {@link $$GlideRecord.sys_declarative_action_model_definition}
         * Mandatory: true
         */
        applicable_to: GlideElement;
        ...
        /**
         * "Action Dispatch" column element.
         * Max Length: 40
         */
        dispatch_action: GlideElement;
    ...
    /**
     * "Action Payload Definition" GlideRecord fields.
     * @see {@link $$GlideRecord.sys_declarative_action_payload_definition}
     * @see {@link $$GlideElement.sys_declarative_action_payload_definition}
     */
    export interface sys_declarative_action_payload_definition extends sys_metadata {
        /**
         * "Key" column element.
         * Max Length: 100; Mandatory: true
         */
        action_key: GlideElement;
        ...
        /**
         * "Payload field table" column element.
         * Max Length: 250; Read-Only: true
         */
        payload_field_table: GlideElement;

        /**
         * "Payload" column element.
         * Type: JSON (json)
         */
        payload_template: GlideElement;
    }

    /**
     * "Declarative Action Render Mode" GlideRecord fields.
     * @see {@link $$GlideRecord.sys_declarative_action_render_mode}
     * @see {@link $$GlideElement.sys_declarative_action_render_mode}
     */
    export interface sys_declarative_action_render_mode extends sys_metadata {
        /**
         * "Applicable To" column element.
         * Type: List (glide_list)
         * References: Action Model Definition {@link $$GlideRecord.sys_declarative_action_model_definition}
    ...
    /**
     * "Declarative Action Group" GlideRecord fields.
     * @see {@link $$GlideRecord.sys_declarative_action_group}
     * @see {@link $$GlideElement.sys_declarative_action_group}
     */
    export interface sys_declarative_action_group extends IBaseRecord {
        /**
         * "Active" column element.
         * Type: True/False (boolean).
         * Default Value: true
    ...
    /**
     * "Design System Icons" GlideRecord fields.
     * @see {@link $$GlideRecord.st_sys_design_system_icon}
     * @see {@link $$GlideElement.st_sys_design_system_icon}
     */
    export interface st_sys_design_system_icon {
        /**
         * "Preview" column element.
         * Type: "NDS Icon" (nds_icon).
         * Max Length: 40; Read-Only: true
         */
        icon: GlideElement;
    ...
    /**
     * "Workspace" GlideRecord fields.
     * @see {@link $$GlideRecord.sys_aw_master_config}
     * @see {@link $$GlideElement.sys_aw_master_config}
     */
    export interface sys_aw_master_config extends sys_metadata {
        /**
         * "Active" column element.
         * Type: True/False (boolean).
         * Default Value: true
        ...
        /**
         * "Brand color 1" column element.
         * Type: "Color" (color).
         * Max Length: 40
         */
        brand_color: GlideElement;

        /**
         * "UX page" column element.
         * References: UX App Shell UI
         */
        compiled_page: $$GlideElement.sys_ux_page;

        /**
         * "UX page registry" column element.
         * References: UX Application
         */
        compiled_page_registry: $$GlideElement.sys_ux_page_registry;
        ...
        /**
         * "Global Search View Config" column element.
         * References: Workspace Global Search Configuration
         * Mandatory: true
         */
        global_search: $$GlideElement.sys_aw_global_search_config;

        /**
         * "Global Search Data Config" column element.
         * References: Search Application Configuration
         * Mandatory: true
         */
        global_search_data: $$GlideElement.sys_search_context_config;

        /**
         * "Hide Search Results Count" column element.
         * Type: True/False (boolean).
         * Default Value: false
         */
        hide_search_results_count: GlideElementBoolean;
         ...
         * Default Value: tab
         */
        navigation_type: GlideElement;

        /**
         * "Notifications enabled" column element.
         * Type: True/False (boolean).
         */
        notifications_enabled: GlideElementBoolean;

        /**
         * "Brand color 2" column element.
         * Type: "Color" (color).
         * Max Length: 40
         */
        primary_color: GlideElement;

        /**
         * "Search enabled" column element.
         * Type: True/False (boolean).
         */
        search_enabled: GlideElementBoolean;

        /**
         * "Show Search Result Redaction Warning" column element.
         * Type: True/False (boolean).
         * Default Value: false
         */
        show_search_result_redaction_warning: GlideElementBoolean;

        /**
         * "User Preference Controls enabled" column element.
         * Type: True/False (boolean).
         * Default Value: true
         */
        user_preference_controls_enabled: GlideElementBoolean;

        /**
         * "Custom Logo" column element.
         * Type: Image (user_image).
         */
        workspace_logo: GlideElementUserImage;

        /**
         * "Workspace URL" column element.
         * Max Length: 80; Mandatory: true
         */
        workspace_url: GlideElement;
    }

    /**
     * "UX App Shell UI" GlideRecord fields.
     * @see {@link $$GlideRecord.sys_ux_page}
     * @see {@link $$GlideElement.sys_ux_page}
     */
    export interface sys_ux_page extends sys_metadata {
        /**
         * "Root element" column element.
         * References: UX Page Element
         */
        root_element: $$GlideElement.sys_ux_page_element;
    ...
    /**
     * "UX Page Element" GlideRecord fields.
     * @see {@link $$GlideRecord.sys_ux_page_element}
     * @see {@link $$GlideElement.sys_ux_page_element}
     */
    export interface sys_ux_page_element extends sys_metadata {
         ...
         * Max Length: 32
         */
        attrs: GlideElementGlideVar;

        /**
         * "Available Child Slots" column element.
         * References: UX Children Definition
         */
        children: $$GlideElement.sys_ux_children;

        /**
         * "Component" column element.
         * References: UX Component Definition
         */
        component: $$GlideElement.sys_ux_lib_component;

        /**
         * "Is a root element" column element.
         * Type: True/False (boolean).
         * Default Value: false
         */
        is_root: GlideElementBoolean;

        /**
         * "Layout" column element.
         * References: UX Children Layout
         */
        layout: $$GlideElement.sys_ux_children_layout;
        ...
        /**
         * "Macroponent Config" column element.
         * Max Length: 8000
         */
        macroponent_config: GlideElement;
         ...
         * References: UX App Shell UI
         */
        page: $$GlideElement.sys_ux_page;

        /**
         * "Parent element" column element.
         * References: UX Page Element
         */
        parent: $$GlideElement.sys_ux_page_element;

        /**
         * "Slot" column element.
         * References: Children Slot
         */
        parent_slot: $$GlideElement.sys_ux_children_slot;

        /**
         * "Picker" column element.
         * References: UX Content Picker
         * Default Value: javascript:(new UxPageElementInvariants(current).pickerDefaultValue())
         */
        picker: $$GlideElement.sys_ux_content_picker;

        /**
         * "Picker Condition" column element.
         * Type: Glide Var (glide_var)
         * Max Length: 32
         */
        picker_condition: GlideElementGlideVar;

        /**
         * "Tree root" column element.
         * References: UX Page Element
         * Default Value: javascript:(new UxPageElementInvariants(current).treeRootDefaultValue())
         */
        tree_root: $$GlideElement.sys_ux_page_element;
    }

    /**
     * "UX Content Placeholder" GlideRecord fields.
     * @see {@link $$GlideRecord.sys_ux_content_placeholder_elem}
     * @see {@link $$GlideElement.sys_ux_content_placeholder_elem}
     */
    export interface sys_ux_content_placeholder_elem extends sys_ux_page_element {
        /**
         * "Limit" column element.
         * Type: Integer (integer).
         */
    ...
    /**
     * "UX Custom Content Extension" GlideRecord fields.
     * @see {@link $$GlideRecord.sys_ux_custom_content_root_elem}
     * @see {@link $$GlideElement.sys_ux_custom_content_root_elem}
     */
    export interface sys_ux_custom_content_root_elem extends sys_ux_page_element {
        /**
         * "Active" column element.
         * Type: True/False (boolean).
         * Default Value: true
        ...
        /**
         * "Applicability" column element.
         * Max Length: 40; Mandatory: true
         * Default Value: any
         */
        applicability: GlideElement;

        /**
         * "Applicable Page Registry" column element.
         * References: UX Application
         */
        applicable_page: $$GlideElement.sys_ux_page_registry;

        /**
         * "Placeholder" column element.
         * References: UX Content Placeholder
         * Mandatory: true
         */
        placeholder: $$GlideElement.sys_ux_content_placeholder_elem;
        ...
        /**
         * "Overrides" column element.
         * References: UX Custom Content Extension
         */
        sys_overrides: $$GlideElement.sys_ux_custom_content_root_elem;
    }

    /**
     * "UX Content Picker" GlideRecord fields.
     * @see {@link $$GlideRecord.sys_ux_content_picker}
     * @see {@link $$GlideElement.sys_ux_content_picker}
     */
    export interface sys_ux_content_picker extends sys_ux_page_element {
        /**
         * "Content Slot" column element.
         * References: UX Content Picker Slot
         */
        content_slot: $$GlideElement.sys_ux_lib_content_picker_slot;
    }

    /**
     * "UX Content Picker Slot" GlideRecord fields.
     * @see {@link $$GlideRecord.sys_ux_lib_content_picker_slot}
     * @see {@link $$GlideElement.sys_ux_lib_content_picker_slot}
     */
    export interface sys_ux_lib_content_picker_slot extends sys_metadata {
        /**
         * "Component" column element.
         * References: UX Component Definition
         * Mandatory: true
        ...
        /**
         * "Content Picker Slot" column element.
         * Max Length: 255; Mandatory: true
         */
        name: GlideElement;
    }
    ...
    /**
     * "Children Slot" GlideRecord fields.
     * @see {@link $$GlideRecord.sys_ux_children_slot}
     * @see {@link $$GlideElement.sys_ux_children_slot}
     */
    export interface sys_ux_children_slot extends sys_metadata {
        /**
         * "Description" column element.
         * Type: Translated Text (translated_text).
         * Max Length: 1000
    ...
    /**
     * "UX Application" GlideRecord fields.
     * @see {@link $$GlideRecord.sys_ux_page_registry}
     * @see {@link $$GlideElement.sys_ux_page_registry}
     */
    export interface sys_ux_page_registry extends sys_metadata {
        /**
         * "Active" column element.
         * Type: True/False (boolean).
         * Default Value: true
        ...
        /**
         * "Admin panel" column element.
         * Type: Document ID (document_id).
         */
        admin_panel: GlideElementDocumentId;

        /**
         * "Admin panel table" column element.
         * Type: table_list
         * Max Length: 40
         */
        admin_panel_table: GlideElement;

        /**
         * "Auth Routes" column element.
         * Type: JSON (json)
         * Max Length: 8000
         */
        auth_routes: GlideElement;
        ...
        /**
         * "Parent App" column element.
         * References: UX Parent Application
         */
        parent_app: $$GlideElement.sys_ux_app;

        /**
         * "URL path" column element.
         * Max Length: 255; Mandatory: true
         */
        path: GlideElement;

        /**
         * "App Shell UI" column element.
         * References: UX Macroponent Definition
         */
        root_macroponent: $$GlideElement.sys_ux_macroponent;
    ...
    /**
     * "UX Parent Application" GlideRecord fields.
     * @see {@link $$GlideRecord.sys_ux_app}
     * @see {@link $$GlideElement.sys_ux_app}
     */
    export interface sys_ux_app extends sys_metadata {
        /**
         * "Active" column element.
         * Type: True/False (boolean).
         * Default Value: true
        ...
        /**
         * "Multiple Experiences" column element.
         * Type: True/False (boolean).
         * Default Value: false
         */
        multiple_experiences: GlideElementBoolean;
        ...
        /**
         * "Primary Experience" column element.
         * References: UX Application
         */
        primary_experience: $$GlideElement.sys_ux_page_registry;

        /**
         * "App Shell Root UI" column element.
         * References: UX Macroponent Definition
         */
        shell_root: $$GlideElement.sys_ux_macroponent;

        /**
         * "App Shell Root Config" column element.
         * Type: JSON (json)
         * Max Length: 8000
         */
        shell_root_config: GlideElement;

        /**
         * "Base theme" column element.
         * References: UX Theme
         */
        theme: $$GlideElement.sys_ux_theme;

        /**
         * "UX App namespace" column element.
         * Max Length: 255
         */
        user_preference_namespace: GlideElement;
    }

    /**
     * "UX Theme" GlideRecord fields.
     * @see {@link $$GlideRecord.sys_ux_theme}
     * @see {@link $$GlideElement.sys_ux_theme}
     */
    export interface sys_ux_theme extends sys_metadata {
        /**
         * "Active" column element.
         * Type: True/False (boolean).
         * Default Value: true
         ...
         * References: UX Theme
         */
        parent: $$GlideElement.sys_ux_theme;
        ...
        /**
         * "Override" column element.
         * References: UX Theme
         */
        sys_overrides: $$GlideElement.sys_ux_theme;
    ...
    /**
     * "Workspace Global Search Configuration" GlideRecord fields.
     * @see {@link $$GlideRecord.sys_aw_global_search_config}
     * @see {@link $$GlideElement.sys_aw_global_search_config}
     */
    export interface sys_aw_global_search_config extends sys_metadata {
        /**
         * "Default" column element.
         * Type: True/False (boolean).
         * Read-Only: true
        ...
        /**
         * "Recent items count" column element.
         * Type: Integer (integer).
         * Default Value: 5
         */
        recent_items_count: GlideElementNumeric;

        /**
         * "Recent terms count" column element.
         * Type: Integer (integer).
         * Default Value: 5
         */
        recent_terms_count: GlideElementNumeric;

        /**
         * "Recent TTL (days)" column element.
         * Type: Integer (integer).
         * Default Value: 30
         */
        recent_ttl_in_days: GlideElementNumeric;

        /**
         * "Tab drilldown items per page" column element.
         * Type: Integer (integer).
         * Default Value: 20
         */
        tab_drilldown_items_per_page: GlideElementNumeric;

        /**
         * "Tab overview items per section" column element.
         * Type: Integer (integer).
         * Default Value: 10
         */
        tab_overview_items_per_section: GlideElementNumeric;
    }
    /**
     * "Filter Condition" GlideRecord fields.
     * @see {@link $$GlideRecord.expercxs_rp_fltr_conditiont_variable}
     * @see {@link $$GlideElement.cxs_rp_fltr_condition}
     */
    export interface cxs_rp_fltr_condition extends cxs_fltr_condition {
        /**
         * "Record Producer Filter Config" column element.
         * References: Filter Configuration
         * Mandatory: true; Read-Only: true
         */
        cxs_rp_fltr_config: $$GlideElement.cxs_rp_fltr_config;
         ...
         * Mandatory: true
         */
        source_variable: $$GlideElement.item_option_new;
    }

    /**
     * "Filter Condition" GlideRecord fields.
     * @see {@link $$GlideRecord.cxs_fltr_condition}
     * @see {@link $$GlideElement.cxs_fltr_condition}
     */
    export interface cxs_fltr_condition extends sys_metadata {
        /**
         * "Active" column element.
         * Type: True/False (boolean).
         * Default Value: true
        ...
        /**
         * "Compare" column element.
         * Max Length: 40
         * Default Value: value
         */
        compare: GlideElement;

        /**
         * "Include if blank" column element.
         * Type: True/False (boolean).
         * Default Value: false
         */
        include_if_blank: GlideElementBoolean;

        /**
         * "Operator" column element.
         * Max Length: 40
         * Default Value: =
         */
        operator: GlideElement;
        ...
        /**
         * "Field to compare" column element.
         * Type: Field Name (field_name)
         * Mandatory: true
         */
        target_field: GlideElement;
    }

    /**
     * "Filter Configuration" GlideRecord fields.
     * @see {@link $$GlideRecord.cxs_rp_fltr_config}
     * @see {@link $$GlideElement.cxs_rp_fltr_config}
     */
    export interface cxs_rp_fltr_config extends cxs_fltr_config {
        /**
         * "Record Producer configuration" column element.
         * References: Record Producer Configuration
         * Mandatory: true; Read-Only: true
         */
        cxs_rp_config: $$GlideElement.cxs_rp_config;
    }

    /**
     * "Filter Configuration" GlideRecord fields.
     * @see {@link $$GlideRecord.cxs_fltr_config}
     * @see {@link $$GlideElement.cxs_fltr_config}
     */
    export interface cxs_fltr_config extends sys_metadata {
        /**
         * "Active" column element.
         * Type: True/False (boolean).
         * Default Value: true
        ...
        /**
         * "Resource configuration" column element.
         * References: Search Resource
         * Mandatory: true
         */
        cxs_search_res_config: $$GlideElement.cxs_search_res_config;
         ...
         * Max Length: 8000
         */
        filter_script: GlideElementScript;
        ...
        /**
         * "Scripted filter" column element.
         * Type: True/False (boolean).
         * Default Value: false
         */
        scripted_filter: GlideElementBoolean;
    ...
    /**
     * "Catalog Template Detail" GlideRecord fields.
     * @see {@link $$GlideRecord.sc_template_detail}
     * @see {@link $$GlideElement.sc_template_detail}
     */
    export interface sc_template_detail extends sys_metadata {
        /**
         * "Applies to Multi-row variable set" column element.
         * Type: True/False (boolean).
         * Default Value: false
         */
        applies_to_multi_row_variable_set: GlideElementBoolean;
         ...
         * Default Value: false
         */
        readonly: GlideElementBoolean;

        /**
         * "Restricted" column element.
         * Type: True/False (boolean).
         * Default Value: false
         */
        restricted: GlideElementBoolean;
         ...
         */
        template: $$GlideElement.sc_template;
